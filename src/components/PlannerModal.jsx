...
// ⚡ Bolt: Memoize PlannerRow to prevent all 24 rows from re-rendering on every keystroke
// Expected Impact: Eliminates input lag when typing by avoiding unnecessary re-renders of unrelated time slots.
const PlannerRow = memo(({ hour, label, value, onChange }) => (
